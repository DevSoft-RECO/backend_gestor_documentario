...
func ConnectDB() {
	...
	// Auto-migración
	if err := DB.AutoMigrate(&models.Agencia{}, &models.Usuario{}, &models.Puesto{}, &models.Categoria{}, &models.Subcategoria{}, &models.Asociado{}, &models.Documento{}, &models.IndicePagina{}); err != nil {
